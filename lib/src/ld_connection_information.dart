...
class LDFailure {
  ...
  static const _failureTypeNames = {
    "INVALID_RESPONSE_BODY": LDFailureType.INVALID_RESPONSE_BODY,
    "NETWORK_FAILURE": LDFailureType.NETWORK_FAILURE,
    "UNEXPECTED_STREAM_ELEMENT_TYPE":
        LDFailureType.UNEXPECTED_STREAM_ELEMENT_TYPE,
    "UNEXPECTED_RESPONSE_CODE": LDFailureType.UNEXPECTED_RESPONSE_CODE,
    "UNKNOWN_ERROR": LDFailureType.UNKNOWN_ERROR
  };
...
class LDConnectionInformation {
  ...
  static const _connectionStateNames = {
    "STREAMING": LDConnectionState.STREAMING,
    "POLLING": LDConnectionState.POLLING,
    "BACKGROUND_POLLING": LDConnectionState.BACKGROUND_POLLING,
    "BACKGROUND_DISABLED": LDConnectionState.BACKGROUND_DISABLED,
    "OFFLINE": LDConnectionState.OFFLINE,
    "SET_OFFLINE": LDConnectionState.SET_OFFLINE,
    "SHUTDOWN": LDConnectionState.SHUTDOWN
  };
  ...
  static LDConnectionInformation? _fromCodecValue(dynamic value) {
    ...
    if (map["lastSuccessfulConnection"] is int) {
      lastSuccessful = DateTime.fromMillisecondsSinceEpoch(
          map["lastSuccessfulConnection"],
          isUtc: true);
    }
    if (map["lastFailedConnection"] is int) {
      lastFailed = DateTime.fromMillisecondsSinceEpoch(
          map["lastFailedConnection"],
          isUtc: true);
    }
