...
/** LaunchdarklyFlutterClientSdkPlugin */
public class LaunchdarklyFlutterClientSdkPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "launchdarkly_flutter_client_sdk")
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      ...
      channel.setMethodCallHandler(LaunchdarklyFlutterClientSdkPlugin())
    }
  }
